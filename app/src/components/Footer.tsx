          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div>
              ...
              <div className="flex gap-4 mt-6">
                {/* LinkedIn */}
                <a href="#" onClick={(e) => e.preventDefault()} className="text-text-muted hover:text-white transition-colors duration-300" aria-label="LinkedIn">
                ...
                {/* X/Twitter */}
                <a href="#" onClick={(e) => e.preventDefault()} className="text-text-muted hover:text-white transition-colors duration-300" aria-label="X (Twitter)">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                  </svg>
                </a>
                {/* GitHub */}
                <a href="#" onClick={(e) => e.preventDefault()} className="text-text-muted hover:text-white transition-colors duration-300" aria-label="GitHub">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div>
              ...
              <ul className="space-y-3">
                {['Collision Avoidance', 'Anomaly Detection', 'Orbit Intelligence'].map((item) => (
                  <li key={item}>
                    <a href="#" onClick={(e) => e.preventDefault()} className="text-base text-text-muted hover:text-white transition-colors duration-300">{item}</a>
                  </li>
                ))}
              </ul>
            </div>
