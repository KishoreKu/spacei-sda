    ...
    <section id="cta" style={{ maxWidth: 1240, margin: '0 auto', padding: '80px 40px 96px' }}>
      <div className="px-6 sm:px-14" style={{ background: '#F2EFE7', border: '1px solid #E7E0D1', borderRadius: 22, paddingTop: 76, paddingBottom: 76, textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap' }}>
          <a href="#" style={{ fontSize: 15, fontWeight: 600, color: '#FBF9F3', background: 'var(--accent,#CC785C)', padding: '15px 28px', borderRadius: 9, textDecoration: 'none' }}>
            Request access
          </a>
          <a href="#" style={{ fontSize: 15, fontWeight: 600, color: '#141311', background: '#FFF', border: '1px solid #DAD3C5', padding: '15px 28px', borderRadius: 9, textDecoration: 'none' }}>
            Contact sales
          </a>
        </div>
      </div>
